...
public class Environment {
    ...
    public Environment(LdapConfiguration ldapConfiguration, boolean useConnectionPool) {
    ...
    public Hashtable getConnectionPoolEnvironments() {
        ...
        env.put(LDAP_CONNECT_POOL_MAXSIZE, ldapConfiguration.getLdapConnectionPoolSize());
        env.put(LDAP_CONNECT_POOL_PREFSIZE, ldapConfiguration.getLdapConnectionPoolPrefSize());
        env.put(LDAP_CONNECT_POOL_TIMEOUT, ldapConfiguration.getLdapConnectionPoolTimeout());
        return env;
    }
}
